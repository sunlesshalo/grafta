...
export const LANGS = {
  ...
  hu: {
    ...
    gh_hero_headline:     'Rögzítsd a gyógyszereket, értékeket és laborokat —<br><em>két perc alatt kész</em>',
    gh_hero_sub:          'Jelentkezz be Google-lel, és a Grafta létrehoz egy privát táblázatot a Drive-odban. Add hozzá a gyógyszereidet, és kezdj el rögzíteni. Nem kell semmit beállítani, nem kell fiókot létrehozni, nincs adat a szervereinken.',
